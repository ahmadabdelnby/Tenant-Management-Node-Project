...
const tenancyService = {
  ...
  formatTenancy(tenancy) {
    return {
      ...
      contractNumber: tenancy.contract_number,
      contractPlace: tenancy.contract_place,
      contractDate: tenancy.contract_date,
      firstPartyName: tenancy.first_party_name,
      firstPartyId: tenancy.first_party_id,
      firstPartyNationality: tenancy.first_party_nationality,
      firstPartyPhone: tenancy.first_party_phone,
      firstPartyAddress: tenancy.first_party_address,
      secondPartyName: tenancy.second_party_name,
      secondPartyId: tenancy.second_party_id,
      secondPartyRepresentativeName: tenancy.second_party_representative_name,
      secondPartyRepresentativeCivilId: tenancy.second_party_representative_civil_id,
      secondPartyRepresentativeNationality: tenancy.second_party_representative_nationality,
      secondPartyRepresentativePhone: tenancy.second_party_representative_phone,
      secondPartyRepresentativeAddress: tenancy.second_party_representative_address,
      secondPartyNationality: tenancy.second_party_nationality,
      secondPartyPhone: tenancy.second_party_phone,
      secondPartyAddress: tenancy.second_party_address,
      contractDuration: tenancy.contract_duration,
      contractNotes: tenancy.contract_notes,
      unit: {
        id: tenancy.unit_id,
        unitNumber: tenancy.unit_number,
        floor: tenancy.unit_floor,
        ...
        buildingArea: tenancy.building_area || null,
        buildingBlock: tenancy.building_block || null,
        buildingAvenue: tenancy.building_avenue || null,
        buildingStreet: tenancy.building_street || null,
        buildingNumber: tenancy.building_number || null,
      },
      tenant: {
  ...
  async getMyTenancies(userId) {
    ...
    return tenancies.map(t => ({
      ...
      contractPlace: t.contract_place,
      contractDate: t.contract_date,
      firstPartyName: t.first_party_name,
      firstPartyId: t.first_party_id,
      firstPartyNationality: t.first_party_nationality,
      firstPartyPhone: t.first_party_phone,
      firstPartyAddress: t.first_party_address,
      secondPartyName: t.second_party_name,
      secondPartyId: t.second_party_id,
      secondPartyRepresentativeName: t.second_party_representative_name,
      secondPartyRepresentativeCivilId: t.second_party_representative_civil_id,
      secondPartyRepresentativeNationality: t.second_party_representative_nationality,
      secondPartyRepresentativePhone: t.second_party_representative_phone,
      secondPartyRepresentativeAddress: t.second_party_representative_address,
      secondPartyNationality: t.second_party_nationality,
      secondPartyPhone: t.second_party_phone,
      secondPartyAddress: t.second_party_address,
      contractDuration: t.contract_duration,
      contractNotes: t.contract_notes,
      unit: {
        id: t.unit_id,
        ...
        buildingArea: t.building_area || null,
        buildingBlock: t.building_block || null,
        buildingAvenue: t.building_avenue || null,
        buildingStreet: t.building_street || null,
        buildingNumber: t.building_number || null,
      },
      tenant: {
        id: t.tenant_id,
        email: t.tenant_email,
        firstName: t.tenant_first_name,
