...
const unitService = {
  ...
  formatUnit(unit) {
    return {
      ...
      building: {
        ...
        area: unit.building_area || null,
        block: unit.building_block || null,
        avenue: unit.building_avenue || null,
  ...
  async getUnitsByBuildingId(buildingId, user) {
    ...
    return units.map(u => ({
      ...
      building: {
        id: u.building_id,
        name: u.building_name,
        nameEn: u.building_name_en,
        nameAr: u.building_name_ar,
        area: u.building_area || null,
        block: u.building_block || null,
        avenue: u.building_avenue || null,
